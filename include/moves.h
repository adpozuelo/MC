...
/**
   ...
   potential excluded) rdmax: maximum trial displacements runit: normalization
   units of the simulation box's length sides r: particles positions (xyz) nsp:
   number of species nspps: accumulated number of species per specie itp:
   interaction potentials between species rc2: cutoff radio Morse/LJ parameters
